...
S = rad * (pi * pi) #площадь окружности 


st_k = rad * sqrt(S) # сторона вписанного квдрата
st_tr = rad * sqrt(3) # сторона вписанного треугольника

st_k_op = rad * 2 # сторона описанного квадрата 
st_tr_op = (rad * 2 * sqrt(3))/3 # сторона описанного треугольника 
st_vsm = 2 * rad * (sqrt(2) - 1) # сторона описанного восьмиугольника
